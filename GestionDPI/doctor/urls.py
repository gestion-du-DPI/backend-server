...
urlpatterns = [
    ...
    path('consultation/get/consultation_id', getConultationView.as_view(), name='get_consultation'),
    path('consultation/attachments/consultation_id', getAttachmentsView.as_view(), name='get_attachments'),
    ...
    path('prescription/get/prescription_id', GetPrescriptionView.as_view(), name='get_prescription'),
    path('dpi/get/<str:nss>', GetDPIView.as_view(), name='get_dpi'),
