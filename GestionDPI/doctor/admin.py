...
from doctor.models import Consultation, Prescription, Medicine,PrescriptionDetail,RadioImage,LabImage,LabObservation,RadioObservation,NursingObservation,NursingResult,RadioResult,LabResult
